...
function startVideo() {
    ...
    navigator.mediaDevices.getUserMedia(constraints)
        .then(function (stream) {
            ...
            // cancel face-api when paused or ended
...
video.addEventListener('play', () => {
    ...
    function buttonClicked() {
        if (capturedImageData) {
            ...
            xhr.open("POST", '/control-room/student-photo-capture', false);
            ...
            window.location.href = '/control-room/student-photo-capture-complete';
