...
class BillPayService
{
    ...
    public function payEnrollmentBill($bill, $payment_method)
    {
        ...
        try {
            ...
            $bill->payment_method = self::getPaymentMethods()[$payment_method];
            $bill->save();
            DB::commit();
    ...
    public function payApplicationBill($bill, $payment_method)
    {
        // find the student for whom the bill belongs
        ...
        try {
            ...
            //update bill
            $bill->payment_status = '1';
            $bill->payment_method = $this->getPaymentMethods()[$payment_method];
            $bill->save();
            //update enrollment
    ...
    public function payPhotoChangeBill($bill, $payment_method)
    {
    ...
    public function payRegistrationBill($bill, $payment_method)
    {
        // find the studen for whom the bill belongs
        try {
            DB::beginTransaction();
