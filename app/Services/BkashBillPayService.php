...
class BkashBillPayService
{

    public function payBill(&$bill, $trxID)
    {
        switch ($bill->payment_purpose) {
            case 'E':
                return $this->payEnrollmentBill($bill, $trxID);
            case 'A':
                return $this->payApplicationBill($bill, $trxID);
            case 'P':
                return $this->payPhotoChangeBill($bill, $trxID);
            default:
                return false;
        }
    ...
    public function payEnrollmentBill(&$bill, $trxID)
    {
    ...
    public function payApplicationBill(&$bill, $trxID)
    {
        // find the student for whom the bill belongs
    ...
    public function payPhotoChangeBill(&$bill, $trxID)
    {
    ...
    public function payRegistrationBill(&$bill, $trxID)
    {
        $bill=Bill::find($bill->id);
