    ...
    <div class="panel panel-default full-height">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <p class="alert alert-info lead">
                        আপনার Hall Choice ফর্ম সফল ভাবে সাবমিট হয়েছে।
            ...
            <div class="row no-print">
                <div class="col-sm-12">
                    <p class="text-center">
                        <a class="btn btn-primary" href="{{ route('hall_choice.downloadHallChoiceForm', session('subjectOption')->id ) }}" role="button">
