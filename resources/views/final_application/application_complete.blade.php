        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                    ...
                    <br>
                    {{ Html::image(Storage::url('public/uploads/'.$student->selfie), 'Photo', array('class'=>'img-responsive img-thumbnail', 'width'=>150)) }}
                </div>
                        ...
                        <tr>
                            <td colspan="2" class="text-center">
                                ...
                                <div class="alert alert-info">
                                    <strong>আপনি পরবর্তীতে যে কোন সময় হোম পেজের "Start Final Application" লিংকে
