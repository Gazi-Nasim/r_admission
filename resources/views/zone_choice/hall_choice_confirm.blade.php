...
@section('body-content')
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <br>
            {{-- Subject Choice --}}
            <legend><i class="fa fa-list-ol"></i> Hall Choice Confirmation for  {{$subjectOption->name}}
            </legend>
            {{-- choice  list --}}
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form method="post" action="{{route('hall_choice.postHallChoiceSave')}}">
                        <p class="text-right">

                            {{csrf_field()}}
                            <a class="btn btn-danger" href="{{ route('hall_choice.getHallChoiceForm') }}"><i
