...
@section('body-content')
    <div class="panel panel-default">
        <div class="panel-body full-height">
            <legend>
                <i class="fa fa-dashboard"></i> Cancel Application [Unit -{{auth()->user()->unit->unit_name}} ]
            </legend>


            <form class="form-inline" ic-indicator='#indicator' ic-target="#result" ic-post-to="{{ route('unit-office.postCancelStudent') }}" id="frm">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    {{ Form::select('bill_status', [""=>'Bill Status']+$bill_types , null, array('class' => 'form-control input-sm') ) }}
                </div>

                <div class="form-group">
                    {{ Form::select('office_status', [""=>'Office Status']+$office_status , null, array('class' => 'form-control input-sm') ) }}
                </div>
