...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-6 col-xs-offset-3">
            <table class="table">
                ...
                <tr>
                    <th class="text-right" style="padding-right: 5px;background-color: #d4d4d4;font-size: 13pt">UNITS
                    </th>
    ...
    <div class="row">
        ...
        <div class="col-xs-4 pull-right text-right" style=" padding: 0;margin: 0;z-index: 100">
            <img src="{{Storage::path('public/uploads/'.$student->photo)}}" style="width: 1.2in;" alt="No Photo Found">
            @if($student->selfie)
            <img src="{{Storage::path('public/uploads/'.$student->selfie)}}" style="width: 1.2in; margin-top: 10px" alt="No Photo Found">
            @else
            <img  src="{{asset('assets/img/Selfie.jpg')}}" style="width: 1.2in; margin-top: 10px" alt="No Photo Found">
            @endif
        </div>
    </div>
    ...
    <div class="well"
         style="border: 1px solid #555;background-color:#eee;font-family: freeserif; font-size: 12pt;text-align: justify; margin-top: 1in">
