...
class CreateHscTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('hsc', function (Blueprint $table) {
            ...
            $table->string('zone_submitted', 10)->nullable();
            $table->string('photo', 100)->nullable();
            $table->string('selfie')->nullable();
            $table->string('suspect_photo')->nullable();
            $table->string('photo_similarity', 16)->nullable();
            ...
            $table->string('photo_status', 20)->nullable()->index('photo_status_idx');
            $table->string('selfie_status', 2)->nullable()->index('hsc_selfie_status_idx');
